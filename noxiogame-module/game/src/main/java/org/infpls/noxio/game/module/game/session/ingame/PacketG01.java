...
public class PacketG01 extends Packet {
  ...
  public PacketG01(final String name, final String gametype, final int maxPlayers, final int scoreToWin, final int teams, final int objective, final NoxioMap map) {
    super("g01");
    this.name = name;
