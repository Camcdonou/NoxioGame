...
public class UserUnlocks {
  ...
  private static final List<Unlock> UNLOCKS = Arrays.asList(
    ...
    new Unlock(Key.CHAR_BLOCK, "Block", "Time for a nap.", Type.CHARACTER, 250, UserData.Type.SPEC, false),
    ...
    new Unlock(Key.ALT_BOXVO, "Talking Box", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_BOXDELTA, "Delta Box", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    ...
    new Unlock(Key.ALT_BOXBLOOD, "Blood Box", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BOXLOOT, "Loot Box", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_CRATEDELTA, "Delta Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_CRATEFIRE, "Spicy Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_CRATELOOT, "Loot Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_VOXVO, "Talking Voxel", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_VOXDELTA, "Delta Voxel", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_VOXBLACK, "Black Voxel", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_VOXLOOT, "Loot Vox", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_QUADVO, "Talking Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_QUADRAINBOW, "Rainbow Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_QUADGOLD, "Solid Gold Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_QUADDELTA, "Delta Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_QUADFIRE, "Spicy Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_QUADLEGEND, "Undying Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_QUADRUNE, "Rune Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_BLOCKVO, "Talking Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BLOCKRAINBOW, "Rainbow Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKGOLD, "Solid Gold Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKDELTA, "Delta Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    ...
    new Unlock(Key.ALT_BLOCKFIRE, "Spicy Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BLOCKRO, "Roblock", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BLOCKLOOT, "Loot Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_CARGOVO, "Talking Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_CARGOPLUS, "Bad Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CARGORAINBOW, "Rainbow Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    ...
    new Unlock(Key.ALT_CARGODELTA, "Delta Block", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_CARGOBLACK, "Blackflame Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CARGOMINE, "Minecargo", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CARGORETRO, "Retro Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, UserData.Type.FULL, true),
