...
public class UserUnlocks {
  public static enum Key {
      CHAR_BOX, CHAR_CRATE, CHAR_VOXEL, CHAR_CARGO, CHAR_BLOCK, CHAR_QUAD, CHAR_CUBE, CHAR_POLY, CHAR_XOB, CHAR_INFERNO,
  ...
  private static final List<Unlock> UNLOCKS = Arrays.asList(
    ...
    new Unlock(Key.CHAR_CUBE, "Cube", "Kaboom.", Type.CHARACTER, 5000, UserData.Type.SPEC, false),
    new Unlock(Key.CHAR_POLY, "Poly", "And then there were many.", Type.CHARACTER, 5000, UserData.Type.SPEC, false),
    new Unlock(Key.CHAR_XOB, "Xob", "Let's do the time warp again!", Type.CHARACTER, 5000, UserData.Type.SPEC, false),
    new Unlock(Key.CHAR_INFERNO, "Plus", "Unsubscribed.", Type.CHARACTER, 100000, UserData.Type.ADMIN, false),
    
    new Unlock(Key.ALT_BOXVO, "Talking Box", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_BOXBLOOD, "Blood Box", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BOXLOOT, "Loot Box", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_CRATEFIRE, "Spicy Crate", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CRATEBLACK, "Blackflame Crate", "Crate with edgy effects.", Type.ALTERNATE, 10000, UserData.Type.FULL, false),
    new Unlock(Key.ALT_CRATELOOT, "Loot Crate", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_VOXVO, "Talking Voxel", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_VOXLOOT, "Loot Voxel", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_QUADLEGEND, "Undying Quad", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_QUADRUNE, "Rune Quad", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_BLOCKVO, "Talking Block", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_BLOCKFIRE, "Spicy Block", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BLOCKRO, "Roblock", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_BLOCKLOOT, "Loot Block", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    
    new Unlock(Key.ALT_CARGOVO, "Talking Cargo", "Now it can talk.", Type.ALTERNATE, 7500, UserData.Type.FULL, false),
    new Unlock(Key.ALT_CARGOPLUS, "Bad Cargo", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.ALT_CARGOBLACK, "Blackflame Cargo", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CARGOMINE, "Minecargo", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    new Unlock(Key.ALT_CARGORETRO, "Retro Cargo", "Descriptions describe things.", Type.ALTERNATE, 9999999, UserData.Type.FULL, true),
    ...
    new Unlock(Key.FT_SOUND, "Custom Sounds", "Allows you to upload and and use a custom sound effect. Plays when you come in 1st place.", Type.FEATURE, 1000000, UserData.Type.SPEC, false)
  );
