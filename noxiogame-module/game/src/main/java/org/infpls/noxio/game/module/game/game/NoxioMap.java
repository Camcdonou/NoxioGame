...
public class NoxioMap {
  ...
  public NoxioMap(final String mapName) throws IOException {
    ...
    for(int i=0;i<ts.length;i++) {
      ...
      if(t.length < 2) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_1"); continue; }
    ...
    for(int i=0;i<dp.length;i++) {
      ...
      if(d.length < 2) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_4"); continue; }
    ...
    for(int i=0;i<dds.length;i++) {
      ...
      if(d.length < 4) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_5"); continue; }
    ...
    for(int i=0;i<cf.length;i++) {
      ...
      if(f.length < 6) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_6"); continue; }
    ...
    for(int i=0;i<cw.length;i++) {
      ...
      if(w.length < 6) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_7"); continue; }
    ...
    for(int i=0;i<sps.length;i++) {
      ...
      if(spwn.length < 4) { Oak.log(Oak.Type.GAME, Oak.Level.ERR, "Error parsing map file: " + mapName + " FIELD_8"); continue; }
